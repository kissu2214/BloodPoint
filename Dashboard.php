            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                        <strong style="color:skyblue">Donate Blood Save Lives</strong></h1>
                    <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                        <a href="Reciver.php" class="btn btn-primary btn-outline-white px-5 py-3">Reciver</a>
                        <a href="Donor.php" class="btn btn-primary btn-outline-white px-5 py-3">Donor</a>
                    </p>
                </div>
            </div>
        </div>
